...
Examples below use `$MERCURY_IMAGE`. Paid AWS Marketplace subscribers use the Marketplace image URI from their subscription instead — see [AWS Marketplace](/aws-marketplace).
